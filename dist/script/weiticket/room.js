...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
	    ...
	    }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)); //END of define
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(22)], __WEBPACK_AMD_DEFINE_RESULT__ = function(_) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	**************/
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
	        ...
	        SeatChooser.onTapSeat = function(evnet) {
	            ...
	            if ($seatDom.hasClass(s_selectname) || $seatDom.hasClass(a_selectname)) {
	                ...
	                if ($seatDom.hasClass(s_selectname)) {
	                    ...
	                    $seatDom.removeClass('available');
	                    $seatDom.addClass('checked');
	                    $checkout_btn.removeClass('disabled').addClass('orangered');
	                    if (this.mySeatCount == this.limitCount) {
	                        // _showModal($seatDom, '<p class="buy-tips">您最多只能购买'+ this.limitCount +'张票</p>', 0);
	                        _showModal( '您最多只能购买'+ this.limitCount +'张票', $seatDom, delayTime );
	                        isCorrectSeat = false;
	                        return;
	                    } else {
	        ...
	        // 错误提示框
	        function _showModal( body, seat, delay ) {
	            var _modal = new Modal();
	            delay = delay || 1e3;
	            _modal.show({
	                body: body,
	        ...
	        function afertSelectSeat(){
	            ...
	            if(seatContainer && locking_seats_dom){
	                ...
	                var $selected_seats = seatContainer.find( ".seat.checked" ),
